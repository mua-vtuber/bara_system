...
MEMORY_EXTRACTION_MIN_IMPORTANCE: float = 0.3
MEMORY_EXTRACTION_CONFIDENCE_THRESHOLD: float = 0.5
MEMORY_REFLECTION_THRESHOLD: int = 20
MEMORY_EVOLUTION_INTERVAL_HOURS: int = 6
MEMORY_MERGE_SIMILARITY_THRESHOLD: float = 0.85
MEMORY_MERGE_MAX_CANDIDATES: int = 500
MEMORY_PRUNE_IMPORTANCE_THRESHOLD: float = 0.2
MEMORY_RECENCY_HALF_LIFE_DAYS: float = 30.0
MEMORY_CONTEXT_TOTAL_BUDGET: int = 4096
MEMORY_RETRIEVAL_LIMIT: int = 10
MEMORY_GRAPH_MAX_HOPS: int = 2
MEMORY_FTS_MAX_RESULTS: int = 20
MEMORY_SCORE_W_RECENCY: float = 0.3
MEMORY_SCORE_W_RELEVANCE: float = 0.5
MEMORY_SCORE_W_IMPORTANCE: float = 0.2
